...
async function main() {
    ...
    db.ref('/vertical_garden').endAt().limitToLast(1).on('child_added', function (snapshot) {
        if (FETCH_STATUS) {
            ...
            chart.data.datasets[0].data.push(parameter.kelembaban)
    ...
    var ctx = document.getElementById('myChart-kelembaban').getContext('2d');
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: FILTERED_DATA.map(data => data.parameter.kelembaban),
            }]
        },
